...
const SCREENS = [
  ...
  // La puerta de cerrar del todo: entra en la lista desde el primer
  ...
  // El catálogo v2: entra en la lista desde el primer día, aunque
  ...
  // Las columnas del catalogo: pintan los titulos y subtitulos de
  ...
  // La pantalla del agente: es una superficie publicada y nunca
  // estuvo en esta lista, así que su copy podía salir en inglés sin que el CI
  // dijera nada.
  'src/components/earn/StrategyLLMChat.tsx',
  // La pantalla de las cuentas: otra superficie publicada que
  ...
  // La banda de flotas del Summary: es la primera pantalla que ve
  ...
  // La tercera puerta de Earn y su registro. Entran en la lista
  ...
  // El contacto con el sitio: sale en la ficha ANTES de firmar y en el
  ...
  // El ajuste de movimiento: una fila de Settings con sus
  // probetas. Entra el mismo dia que nace.
  'src/components/settings/MotionSettings.tsx',
  // El selector de TEMA y LUZ: dos filas de Settings con sus dos
  ...
  // Cierre de la auditoria de fallos silenciosos. Estas pantallas
  ...
  // Ronda: la ceremonia del consejo, la puerta que apaga la master
  ...
  // Ronda del dinero. `inFlightError.ts` es el caso que mas dolia:
  ...
  // Rail institucional: las superficies de la demo. La del
  ...
  // El QR de depósito del cliente, en la zona del cliente y en la mesa.
  ...
  // Demo Exchange v2: la demo custodial completa — exchange, cliente,
  ...
  // El exchange PRODUCTIZADO: la cuenta del cliente y la consola del
  ...
  // La cola de peticiones firmada por el omnibus con QR (sin autopilot).
  'src/components/demo-exchange/console/DeskRequestQueue.tsx',
  // Exchange 2.0: las estructuras cautivas de un tenant. Entra en la
...
const CATALOGUES = [
  'src/components/earn/FlareDemoEarn.tsx',
  // El vocabulario del catalogo. Sus title/sub viajan como DATO y se
