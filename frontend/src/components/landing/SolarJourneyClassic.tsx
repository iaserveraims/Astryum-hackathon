...
/**
 * EL VIAJE DE SIEMPRE — el que pinta PRODUCCIÓN (ver `SolarJourney.tsx`, la
 * puerta). Es el fichero tal y como estaba en 768af3ec^, antes del núcleo y de
 * la quinta órbita, con un único arreglo encima: el CTA final sube por encima
        ...
        return (
          ...
          >
            ...
            <div className="sj-label-pill">
              ...
              <span className="sj-label-text font-mono">{stop ? stop.label : ''}</span>
            </div>
          </motion.div>
        );
      })}
